...
1. **19 年一线实践**：发起人阿do长期参与大型工程，面向几万人的行为培训、指导与管理，持续使用行为观察、风险分层、纠偏和复盘闭环解决真实执行问题。
2. **真实家庭与学校场景**：长期参与家庭教育实践，同时担任孩子学校的兼职讲师，已完成百人次学习行为指导，积累数百个成长行为案例，让方法持续接受真实生活与教学现场的检验。
3. **跨学科方法与公开知识底座**：网站已公开整理 **5 本成长行为入门书目、4 套理论/模型体系、6 个结构化知识节点**，覆盖自我决定理论、COM-B、执行功能与 Fogg 行为模型。每个节点均标注来源、证据等级、适用范围和使用边界，再与行为科学、儿童发展、学习科学、系统工程及 AI 产品化整合为“场景—行为—结果—反馈”的可执行流程。查看[公开知识体系](https://a-do.top/knowledge)与[成长行为入门书单](https://a-do.top/resources/growth-behavior-reading-list)。
